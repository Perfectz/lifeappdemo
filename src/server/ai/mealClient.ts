...
const SYSTEM_PROMPT = [
  ...
  "Calories are kcal; protein, carbs, fat, fiber, and sugar are in grams; sodium is in MILLIGRAMS (mg) — per item as shown (not per 100g).",
  "Sodium is in mg, NOT grams: a nutrition label showing '0.6 g' of sodium is 600 mg. A slice of bread is ~150 mg, a fast-food meal ~1000-1500 mg. Never return sodium in grams.",
