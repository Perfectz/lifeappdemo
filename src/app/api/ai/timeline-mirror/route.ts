...
export async function POST(request: Request) {
  return handleAIRoute(
    request,
    {
      rateLimitKey: "ai-timeline-mirror",
      rateLimitedError: "The Mirror Crystal needs a moment to cool. Try again shortly.",
      notConfiguredError: "Timeline Mirror isn't configured. Add an OpenAI API key to enable it.",
      unavailableError: "The Mirror Crystal went cloudy. Try again in a moment."
    },
    async (body) => {
