...
export async function POST(request: Request) {
  return handleAIRoute(
    request,
    {
      rateLimitKey: "ai-progress",
      rateLimitedError: "Too many assessment requests. Please slow down for a moment.",
      notConfiguredError: "Progress assessment isn't configured. Add an OpenAI API key to enable it.",
      unavailableError: "Couldn't assess your photos right now. Try again in a moment."
    },
    async (body) => {
